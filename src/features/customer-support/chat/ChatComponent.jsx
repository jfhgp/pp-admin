...
const ChatComponent = (props) => {
  console.log("this is all props i receive in chat component", props);
  return (
    <ThemeProvider
      theme={{
      ...
      <TitleBar
        ...
        title={`${
          selectedChat.user
            ...
            : selectedChat.transporter.firstName
          } ${
          selectedChat.user
            ? selectedChat.user.lastName
            : selectedChat.transporter.lastName
          }`}
        rightIcons={[
          <IconButton key="close">
            <CloseIcon onClick={() => props.handleToggleChat(false, selectedChat)} />
          </IconButton>,
        ]}
