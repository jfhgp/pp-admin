...
const TransportersProfileOrderComponent = props => {
        ...
        <Button
          ...
          onClick={() =>
            handleChange("dialogData", {
              comp: TransportersProfileOrderComponent,
              show: false,
              data
            })
          }
...
TransportersProfileOrderComponent.propTypes = {
...
export default TransportersProfileOrderComponent;
