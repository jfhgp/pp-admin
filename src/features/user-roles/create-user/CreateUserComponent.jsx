...
const CreateUserComponent = props => {
  const { activity, errors, handleInputChange, handleCheckBoxChange } = props;
  const permissionKeys = Object.keys(props.permissions);

  return (
    <Page
      className="layout-page user-roles-create-user-page"
      activity={activity}
    ...
    >
      ...
      <DialogContent>
        ...
        <div>
          <Button onClick={props.handleDialogVisibility} disabled={activity}>
            Go Back
          </Button>
          <Button
            variant="contained"
